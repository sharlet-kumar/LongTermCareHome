...
INSERT INTO `allergytreatment` VALUES ('Dust','Increase already begin about four especially professor.','Describe chair ago.'),('Latex','Would company firm recent business safe tough.','Simple concern pretty develop.'),('Mold','Its magazine thousand black voice leg.','Somebody middle describe test market subject.'),('Peanuts','Should check stop artist identify enjoy per identify.','Trip reality remember drive data choose reflect.'),('Pollen','Figure over reduce we major sing nearly.','Society short although drop find audience building.'),('Shellfish','Song protect fund character them military specific.','Assume the good high.');
